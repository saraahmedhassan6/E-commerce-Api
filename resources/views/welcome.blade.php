...
<body class="antialiased">
    <form action="{{ route('testStore') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <h1>Test Product Cloudinary</h1>
        <input type="file" name="images[]" multiple><br>
        <input type="text" name="name" value="" style="border:1px solid black"><br>
        <input type="number" name="price" value="" style="border:1px solid black"><br>
        <input type="number" name="amount" value="" style="border:1px solid black"><br>
        <input type="number" name="discount" value="" style="border:1px solid black"><br>
        <input type="number" name="brand_id" value="" style="border:1px solid black"><br>
        <input type="number" name="category_id" value="" style="border:1px solid black"><br>
        <input type="radio" name="is_trendy" value=0>
        <input type="radio" name="is_trendy" value=1>
